...
<head>
    ...
    <link id="pagestyle" href="https://abdulaziz1999.github.io/assets/vendor/boxicons/css/boxicons.min.css"
        rel="stylesheet" />
</head>
            ...
            <a class="nav-link me-2" href="../pages/sign-in.html">
              ...
              Sign In
                ...
                <!-- <div class="form-check form-switch">
                  <input class="form-check-input" onchange="darkMode()" type="checkbox" id="flexSwitchCheckDefault" checked="">
                  <label class="form-check-label" for="flexSwitchCheckDefault">Dark</label>
                </div>
                &nbsp;&nbsp; -->
                <ul class="navbar-nav d-lg-block m-2">
                  <li class="nav-item">
                    <a href="https://abdulaziz1999.github.io/" target="_blank"
                    class="btn btn-sm mb-0 me-1 bg-gradient-light">Portofolio</a>
                  </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary">
                        ...
                        </script> Design by <b>Abdul Aziz</b>.
                    </p>
                </div>
            </div>
        </div>
